...
<form id="form1" action="<c:url value='/OrderServlet'/>" method="post">
	...
	<c:forEach items="${cartItemList }" var="cartItem">
		<tr align="center">
			...
			<td align="left">
				<a href="<c:url value='/BookServlet?method=findByBookId&bookId=${cartItem.book.bookId}'/>"><span>${cartItem.book.bookName}</span></a>
			</td>
			<td>&yen;${cartItem.book.currentPrice}</td>
		...
		<tr>
			<td colspan="6">
				<input id="addr" type="text" name="address" value="广州市 黄浦区 红山社区 广州航海学院"/>
			</td>
		</tr>
		<tr>
