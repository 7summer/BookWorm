...
<html>
  <head>
	...
	-->
	<link rel="stylesheet" type="text/css" href="<c:url value='/adminfile/css/book/left.css'/>">
...
<c:forEach items="${parents}" var="parent">
  <c:forEach items="${parent.children}" var="child">
	bar.add("${parent.categoryName}", "${child.categoryName}", "<c:url value='/admin/AdminBookServlet?method=findByCategoryId&categoryId=${child.categoryId}'/>", "body");
  </c:forEach>
</c:forEach>
